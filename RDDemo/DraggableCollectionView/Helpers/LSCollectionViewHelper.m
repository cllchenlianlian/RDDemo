...
- (NSIndexPath *)indexPathForItemClosestToPoint:(CGPoint)point
{
    ...
    NSInteger closestDist;
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad) {
        closestDist = 100;//NSIntegerMax;
    }else{
        closestDist = 35;
    }
...
- (void)handleLongPressGesture:(UILongPressGestureRecognizer *)sender
{
    ...
    switch (sender.state) {
        case UIGestureRecognizerStateBegan: {
            ...
            if([sender locationInView:self.collectionView].y < minY)
            {
                return;
            }
            ...
            mockCell = [[IndexPathImageView alloc] initWithFrame:cell.frame];
            mockCell.image = [self imageFromCell:cell];
            mockCenter = mockCell.center;
            mockCell.indexPath = indexPath;
            ...
            [dataSource collectionView:self.collectionView startMoveItemAtIndexPath:indexPath];
        ...
        case UIGestureRecognizerStateCancelled: {
            ...
            id<UICollectionViewDataSource_Draggable> dataSource = (id<UICollectionViewDataSource_Draggable>)self.collectionView.dataSource;
            BOOL moveYes = [dataSource collectionView:self.collectionView moveItemAtIndexPath:fromIndexPath toIndexPath:toIndexPath];
...
- (void)handlePanGesture:(UIPanGestureRecognizer *)sender
{
    if(sender.state == UIGestureRecognizerStateChanged) {
        ...
        id<UICollectionViewDataSource_Draggable> dataSource = (id<UICollectionViewDataSource_Draggable>)self.collectionView.dataSource;
        BOOL isShouldDelete =  [dataSource collectionView:self.collectionView movingItemAtIndexPath:mockCell.indexPath currentLoction:mockCell.frame.origin withMovingCell:mockCell];
        if (isShouldDelete) {
            mockCell.alpha = 0.5;
        }else{
            mockCell.alpha = 1.0;
...
//        id<UICollectionViewDataSource_Draggable> dataSource = (id<UICollectionViewDataSource_Draggable>)self.collectionView.dataSource;
//        [dataSource collectionView:self.collectionView endMoveItemAtIndexPath:mockCell.indexPath withMovingCell:mockCell];
    }
}
